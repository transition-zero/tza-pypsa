...
LOCAL_FILE_PATH =  "C:/Users/jy/Projects/tza-pypsa/Japan_TP1_Hourly_001.csv"  # Eg:"/Users/galib.ktransitionzero.org/Downloads/IEMOP_mnm_data.csv"
RAW_OBJECT_NAME = "Japan_TP1_Hourly_001"  # Eg:"IEMOP_mnm_data"
RAW_CONTENT_TYPE = "text/csv"  # CHANGE if your file is xlsx
LANDING_OBJECT_NAME = "Japan_TP1_Hourly_001"  # Eg: "IEMOP_mnm_data"
DATASET_ID = (
    "japan_pypsa_outputs"  # Allowed values: "india_pypsa_outputs", "taiwan_pypsa_outputs", "japan_pypsa_outputs", "ASEAN_pysa_outputs"
)
BIGQUERY_TABLE_NAME = "Japan_TP1_Hourly_001"  # Eg: "IEMOP_mnm_data"
BIGQUERY_WRITE_METHOD = (
    "WRITE_TRUNCATE"  # CHANGE to "WRITE_TRUNCATE" to overwrite, "WRITE_APPEND" to append to existing data
)
